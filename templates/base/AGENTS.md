...
- `internal/org/` — org runtime mechanism layer: envelope validation, seat saga manifest, receipts, herdr/agmsg driver adapters, role prompt templates (go:embed), typed message protocol (spec: docs/specs/2026-08-01-org-runtime.md; protocol rule: .claude/rules/agent-messaging.md)
