...
7. **Commit gate after each slice (Validation Gate):**
   ...
   - If verification fails in either mode, fix before proceeding. Do not accumulate unverified changes. See `.claude/rules/git-commit-strategy.md`.
