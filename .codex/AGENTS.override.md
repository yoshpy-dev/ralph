...
- **PR metadata and branch naming**: do not identify the driving agent in PR
  ...
  `chore(codex): ...`, `codex/...`, `Generated by Codex`, `Created by Codex`,
  `Co-authored-by: Codex`, or similar provenance labels. Mention Codex only
  when the change itself is about Codex behavior or configuration, not as the
  PR author or creator. Use task-focused repo naming instead, such as
  `<type>/<slug>` or `<type>/<issue>/<slug>`.
