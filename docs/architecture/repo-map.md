...
- `.ralph/local/`: downstream extension points (`hooks/<event>.d/`, `verify.d/`, `test.d/`) that the hooks dispatcher and `scripts/run-verify.sh` execute after core processing
